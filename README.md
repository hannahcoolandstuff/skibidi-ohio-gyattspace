...
```
curl -O https://raw.githubusercontent.com/BreadGhoti1/DesktopOnCodespaces69/main/install.sh
chmod +x install.sh
./install.sh
```
for dev branch (unstable)
```
curl -O https://raw.githubusercontent.com/BreadGhoti1/DesktopOnCodespaces69/main/install-dev.sh
